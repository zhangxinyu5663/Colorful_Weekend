...
export class LoginPage {
  ...
  // reminder(){ //手机号输入错误题型  
  //   this.inp=document.getElementsByClassName('inp');
  //   var r1=document.getElementById('reminder1');
  //   //var r2=document.getElementById('reminder2');
  //   if(this.phone=='' || this.inp[0].value.length!=11){
  //     console.log('手机号错误');
  //     r1.innerHTML='!&nbsp;请填写正确的手机号';
  //   }
  // }
  // reset(){ //重置函数 将span里的内容和输入框里的内容置为空
  //   console.log('reset');
  //   this.inp=document.getElementsByClassName('inp');
  //   var r1=document.getElementById('reminder1');
  //   //var r2=document.getElementById('reminder2');
